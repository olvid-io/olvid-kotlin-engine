...
class ObvBackupKeyInformation(
    keyGenerationTimestamp: Long,
    lastSuccessfulKeyVerificationTimestamp: Long,
    successfulVerificationCount: Int,
    lastBackupExport: Long,
    lastBackupUpload: Long
) {
    @JvmField val keyGenerationTimestamp: Long
    @JvmField val lastSuccessfulKeyVerificationTimestamp: Long
    @JvmField val successfulVerificationCount: Int
    @JvmField val lastBackupExport: Long
    @JvmField val lastBackupUpload: Long
