...
class JsonIdentityDetailsWithVersionAndPhoto {
    @JvmField var version: Int = 0
    @JvmField var identityDetails: JsonIdentityDetails? = null
    ...
    @JsonProperty("details")
    fun setIdentityDetails(identityDetails: JsonIdentityDetails?) {
