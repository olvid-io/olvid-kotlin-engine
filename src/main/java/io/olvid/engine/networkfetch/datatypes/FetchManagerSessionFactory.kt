...
interface FetchManagerSessionFactory {
    @get:Throws(SQLException::class)
    val session: FetchManagerSession?
    fun markOwnedIdentityAsUpToDate(ownedIdentity: Identity?)
    fun markOwnedIdentityAsNotUpToDate(
