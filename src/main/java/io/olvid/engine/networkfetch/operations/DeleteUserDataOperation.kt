        ...
        try {
            fetchManagerSessionFactory.session!!.use { fetchManagerSession ->
                try {
                    ...
                    val serverMethod = DeleteUserDataServerMethod(
                        ownedIdentity,
                        serverSessionToken,
                        label
                    )
                    ...
                    when (returnStatus) {
                        ServerMethod.OK -> {
                            fetchManagerSession.identityDelegate.deleteUserData(
                                fetchManagerSession.session,
                                ownedIdentity,
                                label
                            )
...
internal class DeleteUserDataServerMethod(
    ...
    companion object {
        private const val SERVER_METHOD_PATH = "/deleteUserData"
    }
}