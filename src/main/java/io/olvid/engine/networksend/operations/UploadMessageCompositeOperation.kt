...
class UploadMessageCompositeOperation(
    ...
    init {
        ...
        suboperations[0] = UploadMessageAndGetUidsOperation(
    ...
    companion object {
        ...
        const val RFC_MESSAGE_NOT_FOUND_IN_DATABASE: Int = 1
        const val RFC_NETWORK_ERROR: Int = 3
        const val RFC_IDENTITY_IS_INACTIVE: Int = 10
    }
}
